...
(function($) {
    ...
    PATH.PricingToggler = function() {
        $(".switcher__button").on("click", function(e) {
            ...
            $(".pricing-2__value").removeClass("pricing-2__value--hidden");
            $(".pricing-2__value").toggleClass(
                "pricing-2__value--show pricing-2__value--hide"
            );
        });
    };
    ...
    PATH.TestimonialSlide = function() {
        var testimonialSlider = new Swiper(".clients-slider-2", {
            slidesPerView: 3,
            spaceBetween: 18,
            loop: true,
            autoplay: {
